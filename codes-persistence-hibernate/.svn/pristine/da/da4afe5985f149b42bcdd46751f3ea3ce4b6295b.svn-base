...
/**
 * Hibernate Query Language Warp hibernate 查询包装
 * 
...
public class QueryParameterWrap {
	...
	public QueryParameterWrap setNamedParameter(Map<String, Object> namedParameters) {
		this.namedParameter = namedParameters;
		return this;
	}
